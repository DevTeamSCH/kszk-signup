...
['../dist/js/uikit-core.js']
    .concat(components.map(function (name) { return ("../dist/js/components/" + name + ".js"); }))
    .forEach(function (file) { return document.writeln(("<script src=\"" + file + "\"></script>")); });
...
$(function () {
    ...
    if (dir == 'rtl') {
        ...
        $('link[rel=stylesheet]').each(function (i, el) { return $(el).attr('href', el.href.replace('.css' , '.rtl.css')); });
    }
